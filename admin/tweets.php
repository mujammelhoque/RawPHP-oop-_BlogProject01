                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                        <?php
                                         $q = "SELECT ptweets.*,users.username , users.email, mypoemcata.name FROM `ptweets` LEFT OUTER join users on ptweets.uid=users.id JOIN mypoemcata on ptweets.cid=mypoemcata.id ORDER BY ptweets.created DESC";
